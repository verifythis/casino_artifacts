...
(* separate atomic operation. It reveals problems with the proposed smart    *)
(* contract.                                                                 *)
(*****************************************************************************)
...
RemoveFromPot1(amount) ==
    ...
    /\ UNCHANGED <<state, dbTransfer, secret, guess, pot, bet, wallet, operatorFunds, playerFunds>>
...
\* This property fails because the player can indefinitely refuse to be paid out
